...
namespace NiaBukkit.API.Blocks
{
    public static class BlockFactory
    {
        ...
        public static readonly BlockData LapisBlock = Init(new BlockData(Material.LapisBlock).SetBlockData(3, 3));
        ...
        public static readonly BlockData GoldBlock = Init(new BlockData(Material.GoldBlock).SetBlockData(3, 6).SetSound(SoundEffectType.MetalEffect));
        public static readonly BlockData IronBlock = Init(new BlockData(Material.IronBlock).SetBlockData(5, 6).SetSound(SoundEffectType.MetalEffect));
        public static readonly BlockData Bricks = Init(new BlockData(Material.Bricks).SetBlockData(2, 6));
        ...
        public static readonly BlockData DiamondBlock = Init(new BlockData(Material.DiamondBlock).SetBlockData(5, 6).SetSound(SoundEffectType.MetalEffect));
        ...
        public static readonly BlockData OakFence = Init(new BlockFence(Material.OakFence).SetBlockData(2, 3).SetSound(SoundEffectType.WoodEffect));
        ...
        public static readonly BlockData StoneBricks = Init(new BlockData(Material.StoneBricks).SetBlockData(1.5F, 6));
        public static readonly BlockData MossyStoneBricks = Init(new BlockData(Material.MossyStoneBricks).SetBlockData(1.5F, 6));
        public static readonly BlockData CrackedStoneBricks = Init(new BlockData(Material.CrackedStoneBricks).SetBlockData(1.5F, 6));
        public static readonly BlockData ChiseledStoneBricks = Init(new BlockData(Material.ChiseledStoneBricks).SetBlockData(1.5F, 6));
        ...
        public static readonly BlockData NetherBricks = Init(new BlockData(Material.NetherBricks).SetBlockData(2, 6).SetSound(SoundEffectType.NetherBricksEffect));
        ...
        public static readonly BlockData EmeraldBlock = Init(new BlockData(Material.EmeraldBlock).SetBlockData(5, 6).SetSound(SoundEffectType.MetalEffect));

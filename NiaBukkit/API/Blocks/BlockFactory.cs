...
namespace NiaBukkit.API.Blocks
{
    public static class BlockFactory
    {
        ...
        public static readonly BlockData StickyPiston = Init(new BlockPiston(Material.StickyPiston, true).SetDurability(1.5F));
        public static readonly BlockData Cobweb = Init(new BlockWeb(Material.Cobweb).SetDurability(4));
        ...
        public static readonly BlockData DeadBush = Init(new BlockDeadBush(Material.DeadBush).SetSound(SoundEffectType.GrassEffect));
        ...
        public static readonly BlockData Piston = Init(new BlockPiston(Material.Piston, false).SetDurability(1.5F));
        public static readonly BlockData PistonHead = Init(new BlockPistonExtension(Material.PistonHead).SetDurability(1.5F));
        ...
        public static readonly BlockData Tnt = Init(new BlockTnt(Material.Tnt).SetSound(SoundEffectType.GrassEffect));
        public static readonly BlockData Bookshelf = Init(new BlockData(Material.Bookshelf).SetDurability(1.5F).SetSound(SoundEffectType.WoodEffect));
        ...
        public static readonly BlockData CraftingTable = Init(new BlockCraftingTable(Material.CraftingTable).SetDurability(2.5F).SetSound(SoundEffectType.WoodEffect));
        ...
        public static readonly BlockData OakSign = Init(new BlockSign(Material.OakSign).SetDurability(1).SetSound(SoundEffectType.WoodEffect));
        public static readonly BlockData SpruceSign = Init(new BlockSign(Material.SpruceSign).SetDurability(1).SetSound(SoundEffectType.WoodEffect));
        public static readonly BlockData BirchSign = Init(new BlockSign(Material.BirchSign).SetDurability(1).SetSound(SoundEffectType.WoodEffect));
        public static readonly BlockData AcaciaSign = Init(new BlockSign(Material.AcaciaSign).SetDurability(1).SetSound(SoundEffectType.WoodEffect));
        public static readonly BlockData JungleSign = Init(new BlockSign(Material.JungleSign).SetDurability(1).SetSound(SoundEffectType.WoodEffect));
        public static readonly BlockData DarkOakSign = Init(new BlockSign(Material.DarkOakSign).SetDurability(1).SetSound(SoundEffectType.WoodEffect));
        ...
        public static readonly BlockData OakWallSign = Init(new BlockWallSign(Material.OakWallSign).SetDurability(1).SetSound(SoundEffectType.WoodEffect).SetBase(OakSign));
        public static readonly BlockData SpruceWallSign = Init(new BlockWallSign(Material.SpruceWallSign).SetDurability(1).SetSound(SoundEffectType.WoodEffect).SetBase(OakSign));
        public static readonly BlockData BirchWallSign = Init(new BlockWallSign(Material.BirchWallSign).SetDurability(1).SetSound(SoundEffectType.WoodEffect).SetBase(OakSign));
        public static readonly BlockData AcaciaWallSign = Init(new BlockWallSign(Material.AcaciaWallSign).SetDurability(1).SetSound(SoundEffectType.WoodEffect).SetBase(OakSign));
        public static readonly BlockData JungleWallSign = Init(new BlockWallSign(Material.JungleWallSign).SetDurability(1).SetSound(SoundEffectType.WoodEffect).SetBase(OakSign));
        public static readonly BlockData DarkOakWallSign = Init(new BlockWallSign(Material.DarkOakWallSign).SetDurability(1).SetSound(SoundEffectType.WoodEffect).SetBase(OakSign));
        ...
        public static readonly BlockData Jukebox = Init(new BlockJukeBox(Material.Jukebox).SetBase(OakWood).SetBreakData(2, 6));
        ...
        public static readonly BlockData WhiteStainedGlass = Init(new BlockStainedGlass(Material.WhiteStainedGlass).SetDurability(.3F).SetSound(SoundEffectType.GlassEffect));
        public static readonly BlockData OrangeStainedGlass = Init(new BlockStainedGlass(Material.OrangeStainedGlass).SetDurability(.3F).SetSound(SoundEffectType.GlassEffect));
        public static readonly BlockData MagentaStainedGlass = Init(new BlockStainedGlass(Material.MagentaStainedGlass).SetDurability(.3F).SetSound(SoundEffectType.GlassEffect));
        public static readonly BlockData LightBlueStainedGlass = Init(new BlockStainedGlass(Material.LightBlueStainedGlass).SetDurability(.3F).SetSound(SoundEffectType.GlassEffect));
        public static readonly BlockData YellowStainedGlass = Init(new BlockStainedGlass(Material.YellowStainedGlass).SetDurability(.3F).SetSound(SoundEffectType.GlassEffect));
        public static readonly BlockData LimeStainedGlass = Init(new BlockStainedGlass(Material.LimeStainedGlass).SetDurability(.3F).SetSound(SoundEffectType.GlassEffect));
        public static readonly BlockData PinkStainedGlass = Init(new BlockStainedGlass(Material.PinkStainedGlass).SetDurability(.3F).SetSound(SoundEffectType.GlassEffect));
        public static readonly BlockData GrayStainedGlass = Init(new BlockStainedGlass(Material.GrayStainedGlass).SetDurability(.3F).SetSound(SoundEffectType.GlassEffect));
        public static readonly BlockData LightGrayStainedGlass = Init(new BlockStainedGlass(Material.LightGrayStainedGlass).SetDurability(.3F).SetSound(SoundEffectType.GlassEffect));
        public static readonly BlockData CyanStainedGlass = Init(new BlockStainedGlass(Material.CyanStainedGlass).SetDurability(.3F).SetSound(SoundEffectType.GlassEffect));
        public static readonly BlockData PurpleStainedGlass = Init(new BlockStainedGlass(Material.PurpleStainedGlass).SetDurability(.3F).SetSound(SoundEffectType.GlassEffect));
        public static readonly BlockData BlueStainedGlass = Init(new BlockStainedGlass(Material.BlueStainedGlass).SetDurability(.3F).SetSound(SoundEffectType.GlassEffect));
        public static readonly BlockData BrownStainedGlass = Init(new BlockStainedGlass(Material.BrownStainedGlass).SetDurability(.3F).SetSound(SoundEffectType.GlassEffect));
        public static readonly BlockData GreenStainedGlass = Init(new BlockStainedGlass(Material.GreenStainedGlass).SetDurability(.3F).SetSound(SoundEffectType.GlassEffect));
        public static readonly BlockData RedStainedGlass = Init(new BlockStainedGlass(Material.RedStainedGlass).SetDurability(.3F).SetSound(SoundEffectType.GlassEffect));
        public static readonly BlockData BlackStainedGlass = Init(new BlockStainedGlass(Material.BlackStainedGlass).SetDurability(.3F).SetSound(SoundEffectType.GlassEffect));
